...
import { Button, Linking, SafeAreaView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View } from "react-native";
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.form}>
                ...
                <Text className="font-serif bg-black text-white">Mã OTP không đúng</Text>
            </View>
        </SafeAreaView> 
    );
};
